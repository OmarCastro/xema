...
const NumberSchemaMaker = {
  ...
  instanceProperties: {
    ...
    isSchemaValid () {
      ...
      const isDivisorANumber = typeof this[_divisibleBy] !== 'number'
...
applyFeaturesOn(NumberSchemaMaker, [OptionalValueFeature, GeneratorOptionCleanFeature, SchemaInstanceValidationFeature, BaseSubsetValidationFeature])
