  ...
  instanceProperties: {
    ...
    isSchemaValid () {
      ...
      if (this[_max] != null && typeof this[_max] !== 'number') {
        errors.push(`startsWith value of type "${typeof this[_max]}" is not a number`)
      }
      if (this[_min] != null && typeof this[_min] !== 'number') {
        errors.push(`min value of type "${typeof this[_min]}" is not a number`)
      }
      if (this[_divisibleBy] != null && typeof this[_divisibleBy] !== 'number') {
...
applyFeaturesOn(NumberSchemaMaker, [OptionalValueFeature, GeneratorOptionCleanFeature, BaseSubsetValidationFeature])
