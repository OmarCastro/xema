...
const StringSchemaMaker = {
  ...
  instanceProperties: {
    ...
    contains (text) { return Object.assign(StringSchemaMaker.buildSchema(this), { [_contains]: text }) },
    oneOf (...enumVals) { return Object.assign(StringSchemaMaker.buildSchema(this), { [_enum]: new Set(enumVals) }) },

    get errors () {
      const errors = []
      if (this[_startsWith] != null && typeof this[_startsWith] !== 'string') {
        errors.push(`startsWith value of type "${typeof this[_startsWith]}" is not a string`)
      }
      if (this[_endsWith] != null && typeof this[_endsWith] !== 'string') {
        errors.push(`endsWith value of type "${typeof this[_endsWith]}" is not a string`)
      }
      if (this[_contains] != null && typeof this[_contains] !== 'string') {
        errors.push(`contains value of type "${typeof this[_contains]}" is not a string`)
      }
...
applyFeaturesOn(StringSchemaMaker, [OptionalValueFeature, GeneratorOptionCleanFeature, SchemaInstanceValidationFeature, SchemaValidationResultCacheFeature, BaseSubsetValidationFeature])
