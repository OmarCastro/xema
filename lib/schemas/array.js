const {
  OptionalValueFeature, BaseSubsetValidationFeature, GeneratorOptionCleanFeature,
  SchemaInstanceValidationFeature, SchemaValidationResultCacheFeature
} = require('../features')
  ...
  instanceProperties: {
    ...
    get errors () {
      ...
      if (recordSchema != null) {
        let schemaErrors = recordSchema.errors
        if (Array.isArray(schemaErrors) && (recordSchema.hasErrors === true || recordSchema.hasErrors === false)) {
...
applyFeaturesOn(ArraySchemaMaker, [OptionalValueFeature, GeneratorOptionCleanFeature, SchemaValidationResultCacheFeature, SchemaInstanceValidationFeature, BaseSubsetValidationFeature])
